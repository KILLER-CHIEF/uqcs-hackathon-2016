...
try:
    try:
        ...
        from tornado.singledispatch import singledispatch  # backport
except ImportError:
...
try:
    try:
        ...
        from tornado.backports_abc import Generator as GeneratorType  # type: ignore

    try:
        # py35+
        from inspect import isawaitable  # type: ignore
    except ImportError:
        from tornado.backports_abc import isawaitable
except ImportError:
    if 'APPENGINE_RUNTIME' not in os.environ:
        raise
